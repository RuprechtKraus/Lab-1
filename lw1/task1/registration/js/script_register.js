...
{
  var result = document.getElementsByClassName("registration__check_confirmation")[0].checked;
  if (!result) 
  {
...
function registration()
{
  ...
  var passConfirm = document.getElementsByClassName("password-block__password_repeat")[0].value;
